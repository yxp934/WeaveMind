...
export default function ClassCard({
  ...
  return (
    <div className="bg-white rounded-[8px] border border-gray-200 p-3 shadow-[0px_2px_4px_-1px_rgba(0,0,0,0.05)] hover:shadow-[0px_4px_6px_-2px_rgba(0,0,0,0.1)] transition-all hover:-translate-y-0.5 cursor-pointer">
